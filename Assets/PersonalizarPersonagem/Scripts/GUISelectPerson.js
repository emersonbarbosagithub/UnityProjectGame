...
var nomePerson:String;
var nomePerson2:String;
...
function OnGUI () {
	...
	GUI.BeginGroup(bgGroupAttr);
		...
		if(vezDeEscolha == 1){
			...
			GUI.Label(Rect(bgGroupAttr.width*0.1+2 +resolu,posicaoVertical,bgGroupAttr.width*0.3+resolu,bgGroupAttr.width*0.1+resolu),nomePerson,styFonte);
			...
			if(Screen.width > 600)
				GUI.Label(Rect(bgGroupAttr.width*0.1+2,posicaoVertical,bgGroupAttr.width*0.3,bgGroupAttr.width*0.1),nomePerson2,styFonte);
			else
				GUI.Label(Rect(bgGroupAttr.width*0.1+2,posicaoVertical,bgGroupAttr.width*0.3,bgGroupAttr.width*0.1),nomePerson2,styFonte2);
