...
function voltarProTabuleiro()
{
	...
	if(GameStates1Jogador.turnoDoJogador == 2){
		...
		{			
			var valorRandom: int = Random.Range(46,48);
			print(valorRandom);
...
function OnGUI() {
	...
	if(mostrarOpcoes){
		if(GUI.Button(Rect(Screen.width - (Screen.width/6)*1.25,Screen.height/2,Screen.width/6,Screen.width/6),"Avanca")){
			Jogador2.animation.Play("aprovar");
			GameStates1Jogador.MudarEstado(48);
			//decid2.gameObject.active = true;
			decid2b = true;
			mostrarOpcoes = false;
		...
		if(GUI.Button(Rect((Screen.width/6)/4,Screen.height/2,Screen.width/6,Screen.width/6),"Volta")){
			Jogador2.animation.Play("desaprovar");
			GameStates1Jogador.MudarEstado(49);
			//decid1.gameObject.active = true;
			decid1b = true;
			mostrarOpcoes = false;
			continuar = true;
	...
	if(mostrarOpcoes2){
		if(GUI.Button(Rect(Screen.width - (Screen.width/6)*1.25,Screen.height/2,Screen.width/6,Screen.width/6),"Avanca")){
			Jogador2.animation.Play("aprovar");
			GameStates1Jogador.MudarEstado(47);
			//decid2.gameObject.active = true;
			decid2b = true;
		...
		if(GUI.Button(Rect((Screen.width/6)/4,Screen.height/2,Screen.width/6,Screen.width/6),"Volta")){
			Jogador2.animation.Play("desaprovar");
			GameStates1Jogador.MudarEstado(46);
			//decid1.gameObject.active = true;
			decid1b = true;
			mostrarOpcoes2 = false;
			continuar = true;
	...
	if(decid1b){
		if(Screen.width > 600)
			GUI.Label(Rect(0,Screen.height/2,Screen.width,Screen.height/6),"VOLTE 3 CASAS",estiloLetras);
		else
			GUI.Label(Rect(0,Screen.height/2,Screen.width,Screen.height/6),"VOLTE 3 CASAS",estiloLetras);
	...
	if(decid2b){
		if(Screen.width > 600)
			GUI.Label(Rect(0, Screen.height/2, Screen.width,Screen.height/6),"AVANCE 3 CASAS",estiloLetras);
		else
			GUI.Label(Rect(0, Screen.height/2, Screen.width,Screen.height/6),"AVANCE 3 CASAS",estiloLetras);
	}
