...
function OnGUI () {
	switch(GameStates1Jogador.estadoAtual){
		...
		break;
		case 3:
			jogador1.GetComponent(Jogador1).Mover();
			GameStates1Jogador.MudarEstado(9);	
		break;
		case 4:
			jogador2.GetComponent(Jogador2).Mover();
		...
		case 13: //::::::::::::: Voltando uma casa
			posicionarJogadores();
			jogador1.GetComponent(Jogador1).voltarOuAvancar(-1);
		break;
		...
		case 19: // avança 3 casas
			posicionarJogadores();
			jogador1.GetComponent(Jogador1).voltarOuAvancar2(3);
		break;
		...
		case 22: //volta 4 casas
			posicionarJogadores();
			jogador1.GetComponent(Jogador1).voltarOuAvancar2(-4);
		break;
		case 23:  //Carie Ataca 
			SalvaPositJogadores();
		...
		case 28:
			//volta 5 casas
			posicionarJogadores();
			jogador1.GetComponent(Jogador1).voltarOuAvancar2(-5);
		break;
		...
		case 30: //acanca duas casas
			posicionarJogadores();
			jogador1.GetComponent(Jogador1).voltarOuAvancar2(2);
		break;
		...
		case 34: //fio Dental Maquina Avancar 3 casas
			posicionarJogadores();
			jogador2.GetComponent(Jogador2).voltarOuAvancar2(3);
		break;
		
		case 35: //::::::::::::: Voltando uma casa
			GetComponent(Cameras).mudarCamera(1);
			posicionarJogadores();
			jogador2.GetComponent(Jogador2).voltarOuAvancar(-1);
		break;
		...
		case 37:
			posicionarJogadores();
			jogador2.GetComponent(Jogador2).voltarOuAvancar2(-4);
		break;
		
		case 38:
			posicionarJogadores();
			jogador2.GetComponent(Jogador2).voltarOuAvancar2(2);
		break;
		
		case 39: //voltando 5 casas cena lodo 2
			posicionarJogadores();
			jogador2.GetComponent(Jogador2).voltarOuAvancar2(-5);
		break;
