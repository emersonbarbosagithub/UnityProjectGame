#pragma strict
class Jogador extends MonoBehaviour{
	var main:GameObject;
	...
	function Mover() {
		...
		if(ValorDoDado.face == 1){
			...
			if(GameStates1Jogador.turnoDoJogador == 1){
				ponto = main.GetComponent(CasasTabuleiro).casas[MainScript1Jogador.casaAtualJogador1+1];
			...
			iTween.MoveTo(
				gameObject, iTween.Hash(
					"path",	main.GetComponent(CasasTabuleiro).criarPath(
														MainScript1Jogador.casaAtualJogador1+1,
														MainScript1Jogador.casaAtualJogador1+ValorDoDado.face, 
		...
		if(GameStates1Jogador.turnoDoJogador == 1){
				...
				MainScript1Jogador.casaAtualJogador2 += ValorDoDado.face;
		}
	}
	...
	function voltarOuAvancar (valor){
		...
		if(valor == 1){
			MainScript1Jogador.casaAtualJogador1+=1;
			ponto = main.GetComponent(CasasTabuleiro).casas[MainScript1Jogador.casaAtualJogador1];
		...
		if(valor > 0){
			iTween.MoveTo(
				gameObject, iTween.Hash(
					"path", main.GetComponent(CasasTabuleiro).criarPath(
															MainScript1Jogador.casaAtualJogador1+1,
															MainScript1Jogador.casaAtualJogador1+valor, 
															1),
					"speed", 30,
					"easetype", "linear",
					"oncomplete","mudarEst",
			...
			iTween.MoveTo(
				gameObject, iTween.Hash(
					"path", main.GetComponent(CasasTabuleiro).criarPathVoltando(
															MainScript1Jogador.casaAtualJogador1,
															MainScript1Jogador.casaAtualJogador1+valor, 
															1),
					"speed", 30,
					"easetype", "linear",
	...
	function mudarEstadoAnim(){
		...
		if(GameStates1Jogador.turnoDoJogador == 1){
			...
			if(MainScript1Jogador.casaAtualJogador1 == 2)
			{
				ativaParticles();
			...
			else if(MainScript1Jogador.casaAtualJogador1 == 27){
			...
			else if(MainScript1Jogador.casaAtualJogador1 == 4 ){
			...
			else if(MainScript1Jogador.casaAtualJogador1 == 21||
				MainScript1Jogador.casaAtualJogador1 == 38){
				ativaParticles();
			...
			else if(MainScript1Jogador.casaAtualJogador1 == 5 ||
					MainScript1Jogador.casaAtualJogador1 == 12 ||
					MainScript1Jogador.casaAtualJogador1 == 39
					)
			{
				ativaParticles();
				yield WaitForSeconds(3);
			...
			else if(MainScript1Jogador.casaAtualJogador1 == 6){
				ativaParticles();
				yield WaitForSeconds(3);
				GameStates1Jogador.MudarEstado(18);
			}
			//se o jogador esta com a gengiva machucada
			else if(MainScript1Jogador.casaAtualJogador1 == 9){
				if(imunidadeAtivada){
			...
			else if(MainScript1Jogador.casaAtualJogador1 == 10 ||
					MainScript1Jogador.casaAtualJogador1 == 24 ||
					MainScript1Jogador.casaAtualJogador1 == 35 ||
					MainScript1Jogador.casaAtualJogador1 == 45)
			{
				if(imunidadeAtivada){
					perdeImunidade();
				}else{
			...
			else if(MainScript1Jogador.casaAtualJogador1 == 11){
				if(imunidadeAtivada){
					perdeImunidade();
				}else{
					ativaParticles();
			...
			// Dente de lodo, placa bacteriana gruda nele
			else if(MainScript1Jogador.casaAtualJogador1 == 23){
				if(imunidadeAtivada){
					perdeImunidade();
				}else{
					ativaParticles();
			...
			else if(MainScript1Jogador.casaAtualJogador1 == 14 || 
				MainScript1Jogador.casaAtualJogador1 == 32){
				if(imunidadeAtivada){
					perdeImunidade();
				}else{
					ativaParticles();
			...
			else if(MainScript1Jogador.casaAtualJogador1 == 19){
				if(imunidadeAtivada){
					perdeImunidade();
				}else{
					ativaParticles();
			...
			else if(MainScript1Jogador.casaAtualJogador1 == 15 ||
				MainScript1Jogador.casaAtualJogador1 == 46){
					ativaParticles();
					yield WaitForSeconds(3); // pra simular a cena de animação
			...
			else if(MainScript1Jogador.casaAtualJogador1 == 28){
					ativaParticles();
					yield WaitForSeconds(3); // pra simular a cena de animação
			...
			//cena bafo de onca
			else if(MainScript1Jogador.casaAtualJogador1 == 20 || 
				MainScript1Jogador.casaAtualJogador1 == 36){
				if(imunidadeAtivada){
					perdeImunidade();
				}else{
					aguardarRodada = true;
			...
			//cena greve
			else if(MainScript1Jogador.casaAtualJogador1 == 30 ||
				MainScript1Jogador.casaAtualJogador1 == 44){
				if(imunidadeAtivada){
					perdeImunidade();
				}else{
					aguardarRodada = true;
			...
			// gengiva sangrando 2
			else if(MainScript1Jogador.casaAtualJogador1 == 47){
				if(imunidadeAtivada){
					imunidadeAtivada = false;
					//particleAura.particleSystem.gameObject.active = false;
					particlePerdeAura.particleSystem.Play();
			...
			//cena prenda
			else if(MainScript1Jogador.casaAtualJogador1 == 16 ||
					MainScript1Jogador.casaAtualJogador1 == 26 ||
					MainScript1Jogador.casaAtualJogador1 == 41){
					ativaParticles();
					yield WaitForSeconds(2); // pra simular a cena de animação
			...
			else if(MainScript1Jogador.casaAtualJogador1 == 40)
			{
				ativaParticles();
				yield WaitForSeconds(3);
			...
			else if(MainScript1Jogador.casaAtualJogador1 == 49 ||
				MainScript1Jogador.casaAtualJogador1 == 50 ||
				MainScript1Jogador.casaAtualJogador1 == 51 ||
				MainScript1Jogador.casaAtualJogador1 == 52 ||
				MainScript1Jogador.casaAtualJogador1 == 53 ||
				MainScript1Jogador.casaAtualJogador1 == 54 )
			{
				ativaParticles();
			...
			else if(MainScript1Jogador.casaAtualJogador1 == 33){
				if(imunidadeAtivada){
					imunidadeAtivada = false;
					//particleAura.particleSystem.gameObject.active = false;
					particlePerdeAura.particleSystem.Play();
			...
			else if(MainScript1Jogador.casaAtualJogador1 == 13){
					ativaParticles();
					yield WaitForSeconds(3);
