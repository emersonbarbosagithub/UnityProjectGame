	...
	if(Screen.width > 600){
		switch(GameStates1Jogador.estadoAtual){
			case 9:
				...
				GUI.DrawTexture(
					Rect(
						Screen.width/2 - (imagemPainel.width/1.5)/2,
						-30,
						imagemPainel.width/1.5,
						imagemPainel.height/2 + 50),imagemPainel);
				...
				GUI.DrawTexture(Rect(Screen.width/2 - (imagensDado[0].width/1.5)/2,35,imagensDado[0].width/1.5,imagensDado[0].height/1.5),
				 imagensDado[Jogador1.valorDoDadoJogador1-1]);
			break;
			case 10:
				...
				GUI.DrawTexture(Rect(Screen.width/2 - (imagensDado[0].width/1.5)/2,35,imagensDado[0].width/1.5,imagensDado[0].height/1.5),
				 imagensDado[Jogador2.valorDoDadoJogador2-1]);	
			break;
		...
		switch(GameStates1Jogador.estadoAtual){
			case 9:
				estiloLabel.normal.textColor = Color.blue;
				GUI.DrawTexture(Rect(Screen.width/2 - (imagemPainel.width/3)/2,-30,imagemPainel.width/3,imagemPainel.height/4 + 55),imagemPainel);
